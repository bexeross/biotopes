...
classMerge.ls<-c("SubTmpMrgA","SubTmp2","SubTmp3","SubTmp4","SubTmp5","SubTmp6","SubTmp7","SubTmp8","SubTmp9","SubTmp10",
      "SubTmp11","SubTmp12","SubTmp13","SubTmp14","SubTmp15",            "SubTmp17","SubTmp18","SubTmp19","SubTmp20",
      "SubTmp21","SubTmp22","SubTmp23","SubTmpMrgB","SubTmp25","SubTmp26","SubTmp27","SubTmp28","SubTmp29",
...
writeOGR(my.shp, dsn = file.path(outPath, "Spatial"), "Mega_SubTMPMrg_class_shape_big", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
writeOGR(my.shp.s, dsn = file.path(outPath, "Spatial"), "Mega_SubTMPMrg_class_shape_small", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
write.csv(out.piv, 
          file = file.path(outPath, ("Mega_SubTMPMrg_groups_av_proportion_max.csv"))) #change label

write.csv(out.piv.short, 
          file = file.path(outPath, ("Mega_SubTMPMrg_groups_avGT1_propGT50pc.csv"))) #change label


write.csv(piv.meta, 
          file = file.path(outPath, ("Mega_SubTMPMrg_groups_metadata.csv"))) #change label
