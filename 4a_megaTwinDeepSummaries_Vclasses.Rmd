...
# Make reclassification table
reclassify <- data.frame(level=c(4,6,6,6,6,7,7,7,8,8,7,9,9,8,8,10,10,9,8,9,9,7,7,6,6,7,7,9,9,9,9,8,9,9,6,5,7,9,9,9,9,7,8,8,8,10,12,12,11,9,8,8,8,8,9,9,8,7,9,9,9,9,8,9,8,9,9,8,7,7,6,4,2,2),
                         class=c(16,68,69,70,71,144,145,146,294,295,148,596,597,299,300,1204,1205,603,302,606,607,152,153,77,78,158,159,640,641,642,643,322,646,647,81,41,168,676,677,678,679,170,342,343,344,1380,5524,5525,2763,691,346,347,349,348,700,701,351,176,708,709,710,711,356,714,357,716,717,359,180,181,91,23,6,7),
...
writeOGR(my.shp, dsn = file.path(outPath, "Spatial"), "Mega_SubTMPclass_shape_big", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
writeOGR(my.shp.s, dsn = file.path(outPath, "Spatial"), "Mega_SubTMPclass_shape_small", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
write.csv(out.piv, 
          file = file.path(outPath, ("Mega_SubTMPgroups_av_proportion_max.csv"))) #change label

write.csv(out.piv.short, 
          file = file.path(outPath, ("Mega_SubTMPgroups_avGT1_propGT50pc.csv"))) #change label


write.csv(piv.meta, 
          file = file.path(outPath, ("Mega_SubTMPgroups_metadata.csv"))) #change label
