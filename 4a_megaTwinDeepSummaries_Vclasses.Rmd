...
writeOGR(my.shp, dsn = file.path(outPath, "Spatial"), "Mega_Pclass_shape_big", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
writeOGR(my.shp.s, dsn = file.path(outPath, "Spatial"), "Mega_Pclass_shape_small", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
write.csv(out.piv.short, 
          file = file.path(outPath, ("Mega_Vgroups_avGT1_propGT50pc.csv"))) #change label
