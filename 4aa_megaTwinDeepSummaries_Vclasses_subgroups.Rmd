...
<!-- ##order levels -->
<!-- ```{r} -->
<!-- class.ls<-c("P1","P2","P3","P4","P5","P6","P7","P8","P9","P10",       "P11","P12","P13","P14","P15","P16","P17","P18","P19",          "P20","P21","P22","P23","P24","P25") -->
...
#           file = file.path(outPath, ("Mega_P1_avGT1_propGT50pc.csv"))) #change label
...
write.csv(out.piv, 
          file = file.path(outPath, ("Mega_64subGp_av_proportion_max.csv"))) #change label

write.csv(piv.meta, 
          file = file.path(outPath, ("Mega_64subGp_metadata.csv"))) #change label
