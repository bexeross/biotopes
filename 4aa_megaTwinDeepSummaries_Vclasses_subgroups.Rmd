...
class.ls<-c("P1","P2","P3","P4","P5","P6","P7","P8","P9","P10",
            ...
            "P61","P62","P63","P64")
my.subs$class <- factor(my.subs$class, levels = class.ls)
```
...
my.subs<-subset(clss.ref.mat,class =="Tmp28") #change as needed
```
...
#parent groups
piv.meta.a<-my.subs %>%
  group_by(level12)%>% # change to level you want to see groups at
...
```{r}
 ...
 write.csv(out.piv.short, 
           file = file.path(outPath, ("Tmp28_avGT1_propGT50pc.csv"))) #change label


write.csv(out.piv, 
          file = file.path(outPath, ("Tmp28_av_proportion_max.csv"))) #change label

write.csv(piv.meta, 
          file = file.path(outPath, ("Tmp28_metadata.csv"))) #change label
