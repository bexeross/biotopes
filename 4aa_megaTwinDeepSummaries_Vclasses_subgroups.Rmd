...
```{r}
 ...
 write.csv(out.piv.short, 
           file = file.path(outPath,paste0(my.class,"2_avGT1_propGT50pc.csv"))) #change label


write.csv(out.piv, 
          file = file.path(outPath,paste0(my.class,"2_av_proportion_max.csv"))) #change label

write.csv(piv.meta, 
          file = file.path(outPath,paste0(my.class,"2_metadata.csv"))) #change label
