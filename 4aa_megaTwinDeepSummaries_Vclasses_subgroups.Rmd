...
```{r}
my.subs<-subset(res.mat,class =="P1") #change as needed
...
#parent groups
piv.meta.a<-my.subs %>%
  group_by(level9)%>% # change to level you want to see groups at
...
write.csv(out.piv, 
          file = file.path(outPath, ("Mega_P1_av_proportion_max.csv"))) #change label

write.csv(piv.meta, 
          file = file.path(outPath, ("Mega_P1_metadata.csv"))) #change label
