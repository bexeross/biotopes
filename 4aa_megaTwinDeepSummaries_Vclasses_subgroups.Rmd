...
#parent groups
piv.meta.a<-my.subs %>%
  group_by(level8)%>% # change to level you want to see groups at
...
write.csv(out.piv, 
          file = file.path(outPath, ("Mega_P26_av_proportion_max.csv"))) #change label

write.csv(piv.meta, 
          file = file.path(outPath, ("Mega_P26_metadata.csv"))) #change label
