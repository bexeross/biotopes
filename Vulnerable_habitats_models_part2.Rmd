...
save(list=c("v", "fmlabest", "resp"), file = "WORKSPACE_modeltraining.Rdata") # save in working dir
```
...
## Export, again
```{r}
save(list=c("v", "fmlabest", "resp", "pred"), file = "WORKSPACE_modeltraining.Rdata") # save in working dir
```
